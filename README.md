...
фонарик" и "выключи фонарик", распознаются отдельно от слотов — они
добавлены в грамматику распознавателя напрямую, а не через
префикс+слово-триггер, всегда активны наравне с обычными командами и нигде
не настраиваются (ни в «Командах», ни где-либо ещё в UI). Пока белый экран
...
фонарика, они зашиты напрямую в грамматику распознавателя, не являются
слотами, не настраиваются и не отображаются в UI, всегда активны.
...
8. Последняя страница, «Поддержать», — три QR-кода: отблагодарить меня и подписаться на мои каналы в Telegram и Max. Отсканируйте телефоном.
